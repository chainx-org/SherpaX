    ...
    Balance: Display + FromStr,
{
    ...
    #[rpc(name = "xgatewaycommon_trusteeProperties")]
    fn trustee_properties(
        &self,
        chain: Chain,
        who: AccountId,
        at: Option<BlockHash>,
    ...
    #[rpc(name = "xgatewaycommon_trusteeSessionInfo")]
    ...
    #[rpc(name = "xgatewaycommon_generateTrusteeSessionInfo")]
    ...
    BlockNumber: Codec + Send + Sync + 'static,
{
    ...
    fn trustee_properties(
        ...
        let props = self.generic_trustee_properties(chain, who, at)?;
    ...
    fn trustee_session_info(
        ...
        let info = self.generic_trustee_session_info(chain, session_number, at)?;
    ...
    fn generate_trustee_session_info(
        ...
        let info = self.generate_generic_trustee_session_info(chain, candidates, at)?;
