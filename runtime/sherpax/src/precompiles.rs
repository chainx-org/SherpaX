...
/// 1024-2047 Precompiles that are not in Ethereum Mainnet but are neither SherpaX specific
/// 2048-4095 SherpaX specific precompiles
    ...
    Dispatch<R>: Precompile,
{
    fn execute(
        ...
        match address {
            ...
            // Non-SherpaX specific nor Ethereum precompiles :
            a if a == hash(1024) => {
